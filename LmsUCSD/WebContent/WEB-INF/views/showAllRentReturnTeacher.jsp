        ...
        <div class="col-25">
          ...
          Teacher Rent Book
	        ...
	        <th>Show Detail</th>
                ...
                <tbody>
              <c:forEach var="at" items="${returnTeacherRegisterForm.rentReturnTeachers}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				...
				<td>${at.dueDate}</td>
				<td>${at.lateFeet}</td>
				<td><a href="returnShowBookPath?frmRentId=${at.teaRentId}&frmUserId=TID-${at.teacher.teacherId}" class="btn btn-block btn-outline-primary btn-sm">Show Detail</a></td>
			</tr>		
		</c:forEach>
        </tbody>
            <tfoot>

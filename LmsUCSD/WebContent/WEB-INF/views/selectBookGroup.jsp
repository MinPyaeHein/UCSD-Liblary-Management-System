  ...
  <section class="content">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1>Select Group For Book Register </h1>
           </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admin Home</a></li>
              <li class="breadcrumb-item active">Select Book Group</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
     ...
     <!-- Main content -->
        <div class="card card-success">
                ...
                <h3 class="card-title">Select Book Group</h3>
              </div>
        <div class="card-body">
          <form:form action="selectBookGroupSubmitPath" modelAttribute="bookGroupRegisterForm.bookGroupForm" method="POST" enctype="multipart/form-data" >
              <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
        	      <div class="col-sm-6">
                      ...
                      <div class="form-group">
                       <label>Select Book Group</label>
                       <form:select path="bookGroupId" name="bookGroupId" id="bookGroupId" class="form-control" > 
                       <form:options items="${bookGroupRegisterForm.mapBookGroups}"/>
                       </form:select>
                      </div>
                </div> 
               <div class="form-group">

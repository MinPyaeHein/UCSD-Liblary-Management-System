    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1>Add Book Type </h1>
            <h3>Your Selected Book Groups( ${bookGroupForm.groupName})</h3>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-6">
             <div class="card card-success">
              ...
              <h3 class="card-title">Book Type Register</h3>
              </div>
              <!-- /.card-header -->
          <div class="card-body">
          <form:form action="typeRegisterSubmitPath" modelAttribute="typeRegisterForm.typeForm" method="POST" enctype="multipart/form-data" >
           ...
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Liblary Book Type</h3>
              </div>
              <div class="card-body">
          ...
          <tr>
			...
			<th>Add Type</th>
               ...
               <tbody>
            <c:forEach var="at" items="${typeRegisterForm.types}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.typeId}</td>
				<td>${at.typeName}</td>
				<td>${at.typeCode}</td>
				<td><a class="btn btn-block btn-outline-primary btn-sm" href="addBookTypeSubmitPath?frmTypeId=${at.typeId}">Add</a></td>
			</tr>		
		</c:forEach>	
	            </tbody>
                <tfoot>
          ...
          <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Select Book Type</h3>
              </div>
              <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
          ...
          <c:forEach var="at" items="${typeForms}" varStatus="s">
			<tr>
				...
				<td>${at.typeName}</td>
				<td>${at.typeCode}</td>
				<td><a class="btn btn-block btn-outline-primary btn-sm" href="deleteBookTypeSubmitPath?frmTypeId=${at.typeId}">Delete</a></td>
			</tr>		
		   </c:forEach>
              ...
              <div class="card-body">
              <form:form action="goToBookRegisterPath"  method="POST" enctype="multipart/form-data" >
              <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
        	     <div class="form-group">

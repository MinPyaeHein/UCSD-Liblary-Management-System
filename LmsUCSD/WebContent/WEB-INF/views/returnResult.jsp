        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">${messageForm.title}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
            ...
            <div class="card card-widget widget-user-2">
              ...
              <div class="widget-user-header bg-warning">
                ...
                <img class="img-circle elevation-2" src="bgimageUploadPath?frmImageId=${messageForm.bookId}&frmType=book" alt="User Avatar">
                </div>
              ...
              <div class="card-footer p-0">
                <ul class="nav flex-column">
                 ...
                 <li class="nav-item">
                 <form:form action="selectRentBookPath">

 ...
 <%@ include file="/resources/admin/headerAndSlideBar/headerAndSlideBar.jsp" %>
  ...
  <section class="content">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Major Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="card card-success">
                ...
                <h3 class="card-title">Major Register</h3>
              </div>
        <div class="card-body">
          <form:form action="majorRegisterSubmitPath" modelAttribute="majorRegisterForm.majorForm" method="POST" enctype="multipart/form-data" >
        	...
        	<div class="col-md-6">
				...
				Major Name :
                 ...
                 <form:input type="text" id="majorName" path="majorName" name="majorName"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		 <div class="form-group">
				Short Term :
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Major</h3>
              </div>
        <div class="card-body">
			...
			<th>Delete</th>
                ...
                <tbody>
                <c:forEach var="at" items="${majorRegisterForm.majors}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.majorId}</td>
				<td>${at.majorName}</td>
				<td>${at.shortTerm}</td>
				<td><a href="#" class="btn btn-block btn-outline-primary btn-sm">Add</a></td>
			</tr>		
		    </c:forEach>

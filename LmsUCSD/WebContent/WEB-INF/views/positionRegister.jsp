  ...
  <section class="content">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Position Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
         <div class="card card-success">
                ...
                <h3 class="card-title">Position Register</h3>
              </div>
        <div class="card-body">
          <form:form action="positionRegisterSubmitPath" modelAttribute="positionRegisterForm.positionForm" method="POST" enctype="multipart/form-data" >
        	...
        	<div class="col-md-6">
				...
				Position Name :
                 ...
                 <form:input type="text" id="positionName" path="positionName" name="positionName"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		 <div class="form-group">
				Short Term :
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Position</h3>
              </div>
        <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
               <c:forEach var="at" items="${positionRegisterForm.positions}" varStatus="s">
                <tr>
               <td>${s.index+1}</td>
				<td>${at.positionId}</td>
				...
				<td><a href="#" class="btn btn-block btn-outline-primary btn-sm">Update</a></td>
                </tr>

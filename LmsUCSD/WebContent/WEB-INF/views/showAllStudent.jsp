        ...
        <div class="row mb-25">
          ...
          <div class="col-sm-25">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Show All Student</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                ...
                <h3 class="card-title">Show All Student</h3>
              </div>
        <div class="card-body">
			...
			<tr>
			   ...
			   <td>
			   ${at.gread.greadNo}${at.major.shortTerm}-${at.rollNumber}
               </td>
				<td>${at.gender}</td>
				...
				<td>${at.phone}</td>
				<td>${at.address}</td>
				<td><a href="showDetailStudentPath?frmStudentId=SID-${at.studentId}"class="btn btn-block btn-outline-primary btn-sm">ShowDetail</a></td>

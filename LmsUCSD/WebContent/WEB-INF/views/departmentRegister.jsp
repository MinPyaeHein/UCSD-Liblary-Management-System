        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Department Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-md-6">
             <div class="card card-success">
              ...
              <h3 class="card-title">Department Register</h3>
              </div>
              <!-- /.card-header -->
          <div class="card-body">
          <form:form action="departmentRegisterSubmitPath" modelAttribute="departmentRegisterForm.departmentForm" method="POST" enctype="multipart/form-data" >
        	    ...
        	    Department    Name :
                 ...
                 <form:input type="text" id="departmentName" path="departmentName" name="departmentName"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		  <div class="form-group">
				Short Term :
           ...
           <div class="card card-success">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
               <c:forEach var="at" items="${departmentRegisterForm.departments}" varStatus="s">
                <tr>
               <td>${s.index+1}</td>
				<td>${at.departmentId}</td>
				<td>${at.departmentName}</td>
				<td>${at.shortTerm}</td>
				<td><a href="servicTypeDeletePath?frmServicTypeId=${at.departmentId}" class="btn btn-block btn-outline-primary btn-sm">Delete</a></td>
				<td><a href="servicTypeUpdatePath?frmServicTypeId=${at.departmentId}" class="btn btn-block btn-outline-primary btn-sm">Update</a></td>
                </tr>

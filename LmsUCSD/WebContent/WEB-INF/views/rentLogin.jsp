  ...
  <section class="content">
    ...
    <!-- Main content -->
        <div class="card card-success">
                ...
                <h3 class="card-title">Insert User Info For Rent Book</h3>
              </div>
        <div class="card-body">
          <form:form action="rentBookLoginSubmitPath" modelAttribute="loginForm" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
				...
				User Id :
                 ...
                 <form:input type="text" id="userId" path="userId" name="userId"  class="form-control"  data-mask="data-mask" placeholder="Eg.SID-1/TID-1"/>
                  </div>
         		 </div>
         		  <div class="form-group">
				Password :

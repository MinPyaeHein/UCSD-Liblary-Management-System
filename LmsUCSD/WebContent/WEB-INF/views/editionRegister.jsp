        ...
        <div class="row">
          <div class="col-md-6">
             <div class="card card-success">
              ...
              <h3 class="card-title">Edition Register</h3>
              </div>
              <!-- /.card-header -->
          <div class="card-body">
          <form:form action="bookEditionRegisterSubmitPath" modelAttribute="bookEditionRegisterFrom.bookEditionForm" method="POST" enctype="multipart/form-data" >
        	    ...
        	    <div class="form-group">
                 ...
                 <form:input type="text" id="editionName" path="editionName" name="editionName"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
                 <div class="form-group">
	             <div class="input-group">
           ...
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Library Book Editions</h3>
              </div>
            <div class="card-body">
            ...
            <c:forEach var="at" items="${bookEditionRegisterFrom.bookEditions}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>ID-${at.editionId}</td>
				<td>${at.editionName}</td>
			    <td><a href="doctorDeletePath?frmDoctorId=${at.editionId}"class="btn btn-block btn-outline-primary btn-sm">Delete</a></td>
				<td><a href="doctorUpdatePath?frmDoctorId=${at.editionId}"class="btn btn-block btn-outline-primary btn-sm">Update</a></td>
			</tr>		
		  </c:forEach>
                </tbody>
                <tfoot>

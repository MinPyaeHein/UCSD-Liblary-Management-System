 ...
 <%@ include file="/resources/admin/headerAndSlideBar/headerAndSlideBar.jsp" %>
  ...
  <section class="content">
    ...
    <!-- Main content -->
        ...
        <div class="card-body">
          <form:form action="memberRegisterSubmitPath" modelAttribute="memberRegisterForm.memberForm" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
				...
				Member Name :
                 ...
                 <form:input type="text" id="memberName" path="memberName" name="memberName"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		 <div class="form-group">
				Coin:
                 ...
                 <form:input type="text" id="coin" path="coin" name="coin"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
      ...
      <div class="row">
        ...
        <div class="card-body">
			...
			<th>Update</th>
                ...
                <tbody>
            <c:forEach var="at" items="${memberRegisterForm.members}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>ID-${at.memberId}</td>
				<td>${at.memberName}</td>
				<td>${at.coin}</td>

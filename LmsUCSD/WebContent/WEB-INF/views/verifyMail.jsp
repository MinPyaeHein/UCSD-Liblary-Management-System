  ...
  <section class="content">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1>Verify Your EduMail</h1>
           </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admin Home</a></li>
              <li class="breadcrumb-item active">Verify Mail</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
     ...
     <!-- Main content -->
        <div class="card card-success">
                ...
                <h3 class="card-title">Verify Your EduMail</h3>
              </div>
        <div class="card-body">
          <form:form action="sentCodePath" modelAttribute="verifyEmailForm" method="POST" enctype="multipart/form-data" >
              <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
              ...
              <form:input type="text" id="code" path="code" name="code"  class="form-control" placeholder="Enter the PIN code here"  data-mask="data-mask" />
              <span class="input-group-btn">
              
              <input type="submit" class="btn btn-info btn-flat" name="sendCode" value="SendCode" />
              
              </span>
              </div>
         	  </div>
         	  <div class="form-group">
			  <p>${verifyEmailForm.message}</p>
			  </div>
             ...
             class="btn btn-block bg-gradient-primary btn-m" value="Submit"/>
             </div>
            </div>
              <div class="form-group">
	             <div class="input-group">
             ...
             class="btn btn-block bg-gradient-primary btn-m" value="Cancel"/>
             </div>
            </div> 
          </div>
			 </div>

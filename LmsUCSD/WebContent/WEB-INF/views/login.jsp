...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
     ...
     <form:form action="loginSubmitPath?login=login" modelAttribute="loginForm" method="post">
        <div class="input-group mb-3">
       
         <form:input type="text" id="userId" path="userId" name="userId" class="form-control" placeholder="User Id"/>

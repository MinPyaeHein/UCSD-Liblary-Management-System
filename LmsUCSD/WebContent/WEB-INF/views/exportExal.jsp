...
<head>
  ...
  <title>Computer University Dawei  | Liblary</title>
  ...
  <section class="content">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">${expExalViewForm.title}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
        <div class="card card-success">
                ...
                <h3 class="card-title">${expExalViewForm.title}</h3>
              </div>
        <div class="card-body">
          <form:form action="${expExalViewForm.path}" modelAttribute="expExalViewForm" method="POST"  >
              <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
                   ...
                   <div class="col-sm-6">
                      ...
                      <div class="form-group">
                       ...
                       <form:select path="exalTypeId" name="exalTypeId" id="exalTypeId" class="form-control" > 
                       <form:options items="${expExalViewForm.mapExalTypes}"/>
                       </form:select>
                      </div>
                </div> 
                 <div class="form-group">
             ...
             class="btn btn-block bg-gradient-primary btn-m" value="Export"/>
                    </div>
              </div>
              </div>
              </form:form>
               <div class="form-group">
	             <div class="input-group">
	             <div class="input-group-prepend">
                <form:form action="expDowloadPath"  method="POST"  >
                <input type="submit" name="dowload"
               class="btn btn-block bg-gradient-primary btn-m" value="Download"/>

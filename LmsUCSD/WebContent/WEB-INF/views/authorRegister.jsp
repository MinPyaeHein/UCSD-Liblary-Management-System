 ...
 <%@ include file="/resources/admin/headerAndSlideBar/headerAndSlideBar.jsp" %>
  ...
  <section class="content">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Author Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
        ...
        <div class="card-body">
          <form:form action="authorRegisterSubmitPath" modelAttribute="authorRegisterForm" method="POST" enctype="multipart/form-data" >
